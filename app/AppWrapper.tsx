...
const TOPTANCI_MENU: MenuItem[] = [
    ...
    { href: "/masraflar", label: "Masraflar", icon: "fa-receipt", yetkiler: ["YONETICI", "MUHASEBE"] },
...
const MUSTERI_MENU: MenuItem[] = [
    ...
    { href: "/portal/tahsilat", label: "Tahsilat / Ödeme", icon: "fa-money-bill-wave", section: "FİNANS" },
    { href: "/portal/kasa", label: "Kasa & Nakit Akışı", icon: "fa-cash-register" },
    ...
    { href: "/masraflar", label: "Masraflar", icon: "fa-receipt" },
...
const SAYFA_BASLIK: Record<string, { baslik: string; alt: string }> = {
    ...
    "/masraflar": { baslik: "Masraflar", alt: "Gider ve masraf takibi" },
    ...
    "/portal/tahsilat": { baslik: "Tahsilat / Ödeme", alt: "Alacak ve ödeme kayıtları" },
