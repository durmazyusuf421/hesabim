        ...
        <nav className="flex-1 py-4 space-y-1">
          {aktifSirket.rol === "TOPTANCI" ? (
              ...
              <>
                  ...
                  <Link href="/portal/ekstre" className={`flex items-center px-6 py-3 transition-all ${pathname === "/portal/ekstre" ? "bg-slate-800 text-white border-l-4 border-cyan-500" : "text-slate-300 hover:bg-slate-800 hover:text-white border-l-4 border-transparent"}`}><i className="fas fa-file-invoice-dollar w-6"></i> Cari Ekstre</Link>
