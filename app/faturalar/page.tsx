...
export default function FaturaMerkezi() {
  ...
  const yeniFaturaBaslat = async (tip: "GELEN" | "GIDEN") => {
      ...
      setFaturaKalemleri([{ urun_adi: "", miktar: "", birim: "Adet", birim_fiyat: "", kdv_orani: 20 }]);
      setModalAcik(true);
  };
  ...
  const satirEkle = () => setFaturaKalemleri([...faturaKalemleri, { urun_adi: "", miktar: "", birim: "Adet", birim_fiyat: "", kdv_orani: 20 }]);
